...
export const ProductGrid = ({ products = [], isLoading = false, error = null }) => {
  if (isLoading) {
    return (
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-x-4 sm:gap-x-6 gap-y-10 sm:gap-y-12 animate-pulse">
        {[...Array(8)].map((_, i) => (
  ...
  if (!products || products.length === 0) {
    return (
      <div className="py-24 text-center border border-hairline bg-surface p-8 max-w-lg mx-auto">
